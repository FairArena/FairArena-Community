  ...
  return (
    <>
      <button
        ...
        className={`flex items-center gap-1.5 text-xs font-medium text-muted-foreground hover:text-red-600 dark:hover:text-red-400 transition-colors mt-1 disabled:opacity-50 disabled:cursor-not-allowed`}
